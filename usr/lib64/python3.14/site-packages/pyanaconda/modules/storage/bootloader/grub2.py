...
class GRUB2(BootLoader):
    ...
    def write_defaults(self):
        ...
        defaults.write("GRUB_DEFAULT=0\n")
        defaults.write("GRUB_DISABLE_SUBMENU=true\n")
        if self.console and self.has_serial_console:
            defaults.write("GRUB_TERMINAL=\"serial console\"\n")
            defaults.write("GRUB_SERIAL_COMMAND=\"%s\"\n" % self.serial_command)
        else:
            defaults.write("GRUB_TERMINAL_OUTPUT=\"gfxterm\"\n")
        ...
        defaults.write("GRUB_CMDLINE_LINUX=\"rhgb quiet mitigations=off skew_tick=1 transparent_hugepage=always spectre_bhi=off\"\n")
        defaults.write("GRUB_DISABLE_RECOVERY=\"true\"\n")
        defaults.write("GRUB_THEME=\"/usr/share/evernight-vista-grub/theme.txt\"\n")
